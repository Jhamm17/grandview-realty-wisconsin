      ...
      <section className="relative h-[40vh] min-h-[400px] flex items-center">
        ...
        <div className="container-padding relative z-10 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Get a professional evaluation of your home&apos;s current market value
          </p>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container-padding">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl font-bold mb-6 text-center md:text-left">Request Your Home Evaluation</h2>
              <ContactForm 
                pageTitle="Home Evaluation"
                fields={{
                  name: true,
                  email: true,
                  phone: true,
                ...
                customFields={[
                  ...
                  },
                  {
                    ...
                    options: [
                      ...
                      { value: 'comparative-market-analysis', label: 'Comparative Market Analysis (CMA)' },
                      { value: 'appraisal', label: 'Appraisal' },
                      { value: 'pre-listing', label: 'Pre-Listing Evaluation' },
                      { value: 'investment-analysis', label: 'Investment Analysis' }
                    ]
                  },
                  {
                    name: 'timeline',
                    label: 'When do you need the evaluation?',
                    type: 'select',
                    required: true,
                    options: [
